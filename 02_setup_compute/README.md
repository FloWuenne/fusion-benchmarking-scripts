...
If you are not using Batch Forge to set up your queues, you will also have to manually configure the launch template for the instances used in your AWS Batch compute environment. To do this, add the launch template we provide ([Fusion launch template](./fusion_launch_template.txt)) to your AWS account, then clone or edit your existing AWS compute environment. During the instance configuration step, choose the Fusion launch template you created.
