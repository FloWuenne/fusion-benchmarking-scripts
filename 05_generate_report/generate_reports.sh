...
docker pull cr.seqera.io/scidev/benchmark-reports:sha-46bc022
...
cr.seqera.io/scidev/benchmark-reports:bb28678 /bin/bash -c "quarto render main_benchmark_report.qmd \
--profile cost \
