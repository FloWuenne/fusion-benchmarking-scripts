# Workspace details 
export ORGANIZATION_NAME=your_organization_name                                 ## [CHANGE ME] Seqera Platform Organization name
export WORKSPACE_NAME=your_workspace_name                                       ## [CHANGE ME] Seqera Platform Workspace name    
